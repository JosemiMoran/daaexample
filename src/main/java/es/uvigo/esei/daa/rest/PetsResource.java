...
public class PetsResource {
     ...
     * If the identifier does not correspond with any pet, a 400 Bad Request
     ...
     * @param type the type of the new pet.
     * @return a 200 OK response with a pet that has been created. If the
     * name or the type are not provided, a 400 Bad Request response with an
     ...
     * @param ownerId the new surname of the pet.
     * @return a 200 OK response with a pet that has been modified. If the
     * identifier does not correspond with any pet or the name or type are
    ...
    public Response modify(
        ...
        try {
            ...
            final String message = String.format("Invalid data for pet (name: %s, type: %s)", name, type);
     ...
     * been deleted. If the identifier does not correspond with any pet, a 400
